...
public class EnrollmentServiceImpl implements EnrollmentService {
    ...
    public List<ResponseStatus> enrollLearners(HttpServletRequest request, String meetingId, List<Learner> learners) {
        ...
        List<ResponseStatus> responseStatusList;
        if (learners.isEmpty()) {
            logger.error("Can't process enrollment of empty list of learners");
            throw new ServiceException("Enter enrollment list to process enroll learners to meeting");
        } else {
            ...
            responseStatusList = messageSender.sendMessageToAllRecipientsAndSaveEnrollments(calendarList, meeting);
        }
