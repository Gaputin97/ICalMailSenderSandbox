...
public class EnrollmentServiceImpl implements EnrollmentService {
    ...
    public List<MailSendingResponseStatus> sendCalendarToAllEnrollmentsOfMeeting(HttpServletRequest request, String meetingId) {
        ...
        MeetingType newAppointmentMeetingType = meetingTypeDefiner.defineMeetingType(appointment.getTimeSlots());
        List<Session> sessions = null;
        MeetingType oldAppointmentMeetingType = null;
        if (oldAppointment != null) {
            oldAppointmentMeetingType = meetingTypeDefiner.defineMeetingType(oldAppointment.getTimeSlots());
        }
