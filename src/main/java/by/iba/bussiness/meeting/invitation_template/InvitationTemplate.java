...
public class InvitationTemplate {
    ...
    private String faceToFaceImageUrl;
    private String from;
    ...
    public String getCancelledImageUrl() {
        return cancelledImageUrl;
    }

    public void setCancelledImageUrl(String cancelledImageUrl) {
        this.cancelledImageUrl = cancelledImageUrl;
    }
    ...
    public String getFaceToFaceImageUrl() {
        return faceToFaceImageUrl;
    }

    public void setFaceToFaceImageUrl(String faceToFaceImageUrl) {
        this.faceToFaceImageUrl = faceToFaceImageUrl;
    }
