package by.iba.bussines.calendar.factory.meetings.define.complex;
...
public class ComplexCalendarInvitationTemplate {
    ...
    public Calendar createComplexCalendarInvitationTemplate(SingleMeetingWrapper singleMeetingWrapper, HttpServletRequest request) {
